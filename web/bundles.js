...
var proto_base$types_pb = require('../proto/base-types_pb.js');
...
proto.Person.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    dob: (f = msg.getDob()) && proto_base$types_pb.DateX.toObject(includeInstance, f)
  };
...
proto.Person.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto_base$types_pb.DateX;
      reader.readMessage(value,proto_base$types_pb.DateX.deserializeBinaryFromReader);
      msg.setDob(value);
      break;
    default:
      reader.skipField();
...
proto.Person.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto_base$types_pb.DateX.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional me.app.types.DateX dob = 5;
 * @return {?proto.me.app.types.DateX}
 */
proto.Person.prototype.getDob = function() {
  return /** @type{?proto.me.app.types.DateX} */ (
    jspb.Message.getWrapperField(this, proto_base$types_pb.DateX, 5));
};


/** @param {?proto.me.app.types.DateX|undefined} value */
proto.Person.prototype.setDob = function(value) {
  jspb.Message.setWrapperField(this, 5, value);
};


proto.Person.prototype.clearDob = function() {
 ...
 * @return {!boolean}
 */
proto.Person.prototype.hasDob = function() {
...
},{"../proto/base-types_pb.js":1,"google-protobuf":"google-protobuf"}],3:[function(require,module,exports){
/**
 * @fileoverview
 * @enhanceable
 * @suppress {messageConventions} JS Compiler reports an error if a variable or
...
},{"google-protobuf":"google-protobuf"}],"google-protobuf":[function(require,module,exports){
(function (global){
